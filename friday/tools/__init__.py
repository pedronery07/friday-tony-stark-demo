...
from friday.tools import web, system, memory, weather, github_tool, calendar_tool, timers, spotify_tool, gmail_tool


def register_all_tools(mcp):
    web.register(mcp)
    system.register(mcp)   # get_current_time, get_clipboard
    memory.register(mcp)
